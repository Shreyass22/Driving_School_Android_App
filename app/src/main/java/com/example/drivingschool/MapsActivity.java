...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void showAlert() {
        ...
        dialog.setTitle("Enable Location")
                ...
                .setPositiveButton("Loaction Setting", new DialogInterface.OnClickListener() {
                    @Override
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    public void onLocationChanged(Location location) {
        ...
        mploc.put("latitude", location.getLatitude());
        mploc.put("longitude", location.getLongitude());

        databaseReference.child(firebaseAuth.getCurrentUser().getUid()).updateChildren(mploc);

//        databaseReference.child(firebaseAuth.getCurrentUser().getUid()).setValue(helper).addOnCompleteListener(new OnCompleteListener<Void>() {
//            @Override
